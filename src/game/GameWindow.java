...
public class GameWindow extends JFrame implements ActionListener{
    JButton a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v,
            w, x, y, z;
    ...
    "PAKISTAN", "AUSTRALIA", "AFGHANISTAN", "CHINA"};
    Random rd;
    StringBuffer blanks;
    ...
    public GameWindow(){
        ...
        notify = new JPanel();
        notify.setBorder(javax.swing.BorderFactory.createLineBorder(new 
        ...
        keypad = new JPanel();
        keypad.setBorder(javax.swing.BorderFactory.createLineBorder(new 
        java.awt.Color(0, 0, 0)));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        for (int loop=0;loop<len;loop++){
            if(letter.charAt(0) == word[rnd].charAt(loop)){
                ...
                //this line throws an exception. need to fix it.
                count++;
            }
        }
        ...
        if(count == len){
            JOptionPane.showMessageDialog(this, "Congrats! You guessed the word"
                    + " correctly!");
            int n = JOptionPane.showConfirmDialog(this, "Do you want "
                    + "to play again?", "Restart Game", 
        ...
        if(chance > 5){
            JOptionPane.showMessageDialog(this, "Sorry, you lost your "
                    + "chances!");
            int n = JOptionPane.showConfirmDialog(this, "Do you want to play "
                    + "again?", "Restart Game", JOptionPane.YES_NO_OPTION,
